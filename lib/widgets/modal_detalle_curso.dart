...
class _ModalDetalleCursoContenido extends StatefulWidget {
  ...
  @override
  State<_ModalDetalleCursoContenido> createState() =>
      _ModalDetalleCursoContenidoState();
}

class _ModalDetalleCursoContenidoState
    extends State<_ModalDetalleCursoContenido> {
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      _curso["descripcion"] ??
                          "Descripción general del curso no disponible.",
